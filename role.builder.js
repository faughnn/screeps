...
// 	}
        ...
        if(creep.memory.harvest){
            ...
            //console.log("source: " + creep.harvest(sources[0]));
            if(creep.harvest(sources[creep.memory.i]) == ERR_NOT_IN_RANGE) {
                creep.moveTo(sources[creep.memory.i]);
                creep.say('B' + creep.memory.i);
            }
        }
    }
};
